...
HD_PWD='C:/Users/Ivan/Documents/Digital-electronics-1/Labs/03-vivado/03-vivado/03-vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_comparator_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_comparator_2bit.tcl -notrace

...
HD_PWD='C:/Users/Ivan/Documents/Digital-electronics-1/Labs/03-vivado/03-vivado/03-vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_comparator_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_comparator_2bit.tcl
